...
This dorkshop is about the [openFrameworks](http://openframeworks.cc) C++ toolkit and will use [GitHub.com](https://github.com/) as the online platform to share code, research notes and papers. (Please read and follow the [setup](Setup.md) document BEFORE coming to class.)  
